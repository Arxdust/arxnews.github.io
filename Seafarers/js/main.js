...
window.addEventListener('load', function() {
    ...
    btnSwitchFont.addEventListener('click', () => {
        if (btnSwitchFont.classList.contains('low')) {
            btnSwitchFont.classList.add('high');
    ...
    function localStorageText(arg) {
        if (typeof arg == 'string') {
            localStorage.setItem('textRange', arg);
        }
    }
