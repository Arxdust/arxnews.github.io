window.addEventListener('load', () => {
    ...
    if (searchField != null && searchNews != null && searchNewsBtnIn != null) {
        ...
        function svgSearchOrClear() {
            searchField.value.length > 0 ? svg.innerHTML = searchNewsIconClear : svg.innerHTML = searchNewsIcon;
        }
